...
pub fn prerequisites<'a>(arguments: &'a ArgMatches) -> Vec<Rule<'a>> {
    vec![
        ...
        verbose: "Included eliptic-curve signing key rule",
        },
        Rule {
            ...
            verbose: "Included provide public key rule",
        },
        Rule {
            ...
            verbose: "Included contributor agreement rule",
        },
        Rule {
            ...
            verbose: "Included standard Git configuration rule",
        },
        Rule {
            ...
            verbose: "Included Git configuration with gpg signing and signoff rule",
        },
        Rule {
            ...
            verbose: "Included Git pre-commit hook rule",
        },
        Rule {
            ...
            verbose: "Included Amaranth Git commit-msg hook rule",
        },
    ]
}
